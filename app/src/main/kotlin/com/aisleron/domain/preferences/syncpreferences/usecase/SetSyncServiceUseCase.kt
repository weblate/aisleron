...
class SetSyncServiceUseCase(private val syncPreferencesRepository: SyncPreferencesRepository) {
    operator fun invoke(value: SyncServicePreference) {
        syncPreferencesRepository.setSyncService(value)
    }
}