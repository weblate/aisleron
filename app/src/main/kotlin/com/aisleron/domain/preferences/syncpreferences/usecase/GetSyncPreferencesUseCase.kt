...
class GetSyncPreferencesUseCase(private val syncPreferencesRepository: SyncPreferencesRepository) {
    operator fun invoke(): SyncPreferences =
        syncPreferencesRepository.getSyncPreferences()
}