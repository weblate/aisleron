...
* Multiple Devices: Keep shopping lists up to date across multiple devices using a [self-managed sync service](https://aisleron.com/docs/sync-service/).

## Why you'll love it
* Free, no ads.
* No location tracking, no telemetry tracking, no sharing of shopping habits.
